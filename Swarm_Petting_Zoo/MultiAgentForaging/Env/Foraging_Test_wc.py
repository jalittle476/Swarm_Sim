from Foraging_World_wc import ForagingEnvironment
import numpy as np
import pygame
...
env = ForagingEnvironment(num_agents=20, size = 25, render_mode="human", show_fov = True, draw_numbers=False, num_resources=200)
env.reset(seed=42)
